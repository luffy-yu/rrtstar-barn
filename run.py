...
if __name__ == "__main__":
    ...
    mrpt_map_launch = join(base_path, '..', 'tps_rrtstar/launch/mrpt_map_server.launch')
    ...
    mrpt_local_obstacles = join(base_path, '..', 'tps_rrtstar/launch/mrpt_local_obstacles.launch')
    mrpt_obs_process = subprocess.Popen([
        'roslaunch',
        mrpt_local_obstacles,
    ])

    mrpt_localization = join(base_path, '..', 'tps_rrtstar/launch/mrpt_localization.launch')
